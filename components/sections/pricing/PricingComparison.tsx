...
import { PricingCompareStickyHeader } from "@/components/sections/pricing/PricingCompareStickyHeader";
export function PricingComparison() {
  return (
    <>
      <section id="pricing-comparison-section" className="pricing-plans-scope pt-8 pb-2 px-4 sm:px-6 bg-surface-muted">
            <PricingStaggerReveal />
            <PricingCompareStickyHeader />
            <div className="max-w-7xl mx-auto">
              ...
              <div id="pricing-comparison">
                ...
                <div id="pricing-compare-sticky-root">
                  <div
                    className="pricing-compare-table-wrap overflow-x-auto overflow-y-hidden rounded-[4px] border border-gray-200 bg-white shadow-sm"
                  >
